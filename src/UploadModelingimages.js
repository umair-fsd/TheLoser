...
class UploadModelingimages extends React.Component {
  componentDidMount() {
      ...
      axios
        ...
        .then((res) => {
          if (res.data === 1) {
            ...
            return history.push("/ActingAndModeling");
          }
        });
    }
  }
    ...
    return (
      <div>
        ...
        <Container>
          ...
          <Row className="uploadquotessmargintop">
            <Col>
...
UploadModelingimages.propTypes = {
  classes: PropTypes.object.isRequired,
  history: PropTypes.object,
  errors: PropTypes.object,
};
export default UploadModelingimages;
