...
class Videoslist extends React.Component {
  ...
  fetchdata() {
    axios
      .post(window.$API_URL + "videosgallery", this.state.articlelist)
      .then((res) => {
        this.setState({
  ...
  Mostviewed() {
    axios
      .post(window.$API_URL + "videosgalleryMostviewed", this.state.articlelist)
      .then((res) => {
        this.setState({
          articlelist: this.props.match.params.value,
        });
  ...
  Recentuploaded() {
    axios
      .post(
        window.$API_URL + "videosgalleryRecentuploaded",
