...
import { Button, Container, Col, Row, Card, Popover, Input, OverlayTrigger, Nav, Navbar, NavDropdown, Image, Text, Form, FormGroup, Label } from 'react-bootstrap';
import $ from "jquery";
...
class CookiePolicy extends Component {
  ...
  render() {
    return <div className="nnn">
      <Container>

        <h2>Cookie Policy for THELOSER</h2>
        <p>This is the Cookie Policy for THELOSER, accessible from https://www.theloser.live</p>
        <p><strong>What Are Cookies</strong></p>
        <p>As is common practice with almost all professional websites this site uses cookies, which are tiny files that are downloaded to your computer, to improve your experience. This page describes what information they gather, how we use it and why we sometimes need to store these cookies. We will also share how you can prevent these cookies from being stored however this may downgrade or 'break' certain elements of the site&rsquo;s functionality.</p>
        ...
        <ul>
          <li>Email: contactus.theloser@gmail.com</li>
        </ul>
        <p>&nbsp;</p>
      </Container>
